function [weights,sphere,meanvar,bias,signs,lrates,data,y] = f_infomaxICA(data,varargin) % NB: Now optionally returns activations as variable 'data' -sm 7/05
...
DEFAULT_VERBOSE      = 0;         % write ascii info to calling screen
